...
import com.psvlasenko.entities.SingerCfg;
...
public class SingerServiceImpl implements SingerService {
    ...
    public List<Singer> findAll() {
        return em.createNamedQuery(SingerCfg.FIND_ALL, Singer.class).getResultList();
    }

    // @Transactional(readOnly=true)
    // @Override
    // public List<Singer> findAllWithAlbum() {
    //     List<Singer> singers = em.createNamedQuery(SingerCfg.FIND_ALL_WITH_ALBUM, Singer.class).getResultList();
    //     return singers;
    // }
    ...
    public Singer findById(Long id) {
        TypedQuery<Singer> query = em.createNamedQuery(SingerCfg.FIND_SINGER_BY_ID, Singer.class);
